...
init_client (){
	...
	error_message "#      This setup will override       #"
	error_message "#    any existing wireguard config    #"
	error_message "#                                     #"
	error_message "#    Make sure you are running this   #"
	error_message "#    script on a client/peer machine  #"
	error_message "#  	   and not on your wireguard     #"
